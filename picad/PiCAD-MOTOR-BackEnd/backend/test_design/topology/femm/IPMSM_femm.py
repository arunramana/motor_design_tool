...
class GenerateFEMM_IPMSM:
    ...
    def add_magnet_property(self):
        ...
        r1 = self.pole_dist-(self.pole_width/2) #2.1 due to some discrepancy
    ...
    def add_circuit_property(self):
        ...
        winding_pattern = GenerateFEMM_IPMSM.getWindingPattern(self.no_slots,self.no_poles)
        
        #print(winding_pattern)
        ...
        for no in range(self.no_slots):
            ...
            incircuit,turns = GenerateFEMM_IPMSM.getCircuitAndTurns(winding,self.no_turns)
