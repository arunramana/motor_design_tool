...
draw.add_line(pts[0], pts[4], ph=5, coherence=False);
pt = draw.add_point(2, 2, coherence=False)
draw.add_line(pt, pts[4], ph=7, coherence=False);

# %%
draw.plot()

# %% Save geo
geo.save_geo(draw, 'test_geo_4', 0.3, call_triangle=True, gmsh_mesh=None)
